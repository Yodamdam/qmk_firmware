...
[1] = LAYOUT_75_ansi(
    ...
    _______,            S(KC_7),        S(KC_BSLS),     S(KC_LBRC),     S(KC_RBRC),     XXXXXXX,        KC_SLSH,        KC_7,           KC_8,           KC_9,           KC_COMM,        XXXXXXX,        XXXXXXX,                        _______,        _______,
    _______,            S(KC_COMM),     S(KC_DOT),      S(KC_9),        S(KC_0),        S(KC_MINS),     KC_MINS,        KC_4,           KC_5,           KC_6,           KC_0,           KC_EQL,                                         _______,        _______,
    _______,                            XXXXXXX,        KC_LBRC,        KC_RBRC,        XXXXXXX,        KC_PAST,        KC_PPLS,        KC_1,           KC_2,           KC_3,           KC_DOT,                         _______,        _______,        _______,
